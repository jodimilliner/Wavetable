...
emcc \
  ...
  -s NO_EXIT_RUNTIME=1 \
  -s EXPORTED_FUNCTIONS='["_synth_init","_synth_set_freq","_synth_set_amp","_synth_set_wave","_synth_set_wave1","_synth_set_wave2","_synth_set_detune1","_synth_set_detune2","_synth_render","_synth_note_on","_synth_note_off","_synth_note_off_midi","_synth_set_env","_synth_set_poly","_synth_filter_set","_synth_filter_env","_synth_filter_env_amount","_synth_lfo_set","_synth_lfo_amount_semi","_synth_shutdown","_malloc","_free"]' \
