// Load wavetable UI partial synchronously before wiring events
(function loadWavetableView(){
  var mount = document.getElementById('wavetable');
  if (!mount) return;
  try {
    var xhr = new XMLHttpRequest();
    xhr.open('GET', 'wavetable.html', false);
    xhr.send(null);
